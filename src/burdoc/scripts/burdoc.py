...
def run():
    ...
    argparser.add_argument(
        'out_file', type=str, help="Path to file to write output to.\nDefaults to [in-file-stem].json", nargs="?")
    argparser.add_argument(
        '--pages',  help="List of pages to process. Accepts comma separated list and ranges specified with '-'", required=False, default=None)
    ...
    argparser.add_argument("--single-threaded", action="store_true", required=False,
