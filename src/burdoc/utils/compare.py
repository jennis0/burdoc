...
def compare(obj1: Dict[str, Any], obj2: Dict[str, Any], ignore_paths: List[str]=[]) -> List[Dict[str, Any]]:
    ...
    """
    changes = [c for c in _do_diff("", obj1, obj2) if c['path'] not in ignore_paths]
    return changes